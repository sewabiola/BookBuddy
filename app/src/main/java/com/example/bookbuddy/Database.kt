...
object BookBuddyDatabase {
    ...
    private val reviewVotes: MutableMap<String, MutableMap<String, Int>> = mutableMapOf()
    ...
    // generates token to reset password (only demo)
    ...
    fun initializeSampleData() {
        ...
        passwords["user@example.com"] = passwords["user@example.com"] ?: "password123"
